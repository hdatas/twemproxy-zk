...
### Lists
    ...
    +-------------------+------------+---------------------------------------------------------------------------------------------------------------------+
    |       BRPOP       |    YES*      | BRPOP key [key ...] timeout                                                                                         |
    +-------------------+------------+---------------------------------------------------------------------------------------------------------------------+
    ...
    +-------------------+------------+---------------------------------------------------------------------------------------------------------------------+
* BRPOP support for celery app. celery's brpop command has a timeout of 1 second, so we increased the brpop msg timeout by 1 second. But here is another issue
when brpop is not fast enough to complete and cause timeout, celery app might stop with connection timeout.
...
### Transactions
    ...
    |      UNWATCH      |    YES*      | UNWATCH                                                                                                             |
    +-------------------+------------+---------------------------------------------------------------------------------------------------------------------+
    |       WATCH       |    YES*      | WATCH key [key ...]                                                                                                 |
    +-------------------+------------+---------------------------------------------------------------------------------------------------------------------+

    * All transaction command should go to same partition of ardb instance.
